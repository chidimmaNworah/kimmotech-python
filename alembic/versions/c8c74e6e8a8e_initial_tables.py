...
Revision ID: c8c74e6e8a8e
Revises: 
Create Date: 2025-06-01 11:57:35.907561
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('careers_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['career_categories.id'], name='careers_category_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='careers_pkey'),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('career_categories_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('id', name='career_categories_pkey'),
    sa.UniqueConstraint('name', name='career_categories_name_key'),
    postgresql_ignore_search_path=False
    )
